...
export default function BookPage() {
  return (
    <>
      <div style={{ background: "linear-gradient(160deg,#1a0e08 0%,#0f0905 100%)", paddingTop: "calc(98px + 3rem)", paddingBottom: "4rem", borderBottom: "1px solid rgba(255,255,255,.06)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: "0 2.5rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          <div>
            ...
            <h1 style={{ fontFamily: "var(--serif)", fontSize: "clamp(3rem,5vw,5rem)", fontWeight: 700, color: "#F2EDE4", letterSpacing: ".04em", lineHeight: 1, marginBottom: "1.5rem" }}>
              <span style={{ color: "#7A3A28" }}>UN</span>RETIRE
            </h1>
            ...
            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              <a href="https://amazon.com" target="_blank" rel="noopener noreferrer" style={{ padding: ".75rem 2rem", background: "#7A3A28", color: "#fff", borderRadius: 4, fontSize: ".8rem", fontWeight: 700, letterSpacing: ".07em", textTransform: "uppercase", textDecoration: "none" }}>Buy on Amazon</a>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <Image src="/assets/images/book-unretire-cover.png" alt="UnRetire book cover" width={260} height={360} style={{ borderRadius: 6, boxShadow: "0 24px 64px rgba(0,0,0,.6)" }} />
          </div>
        </div>
      </div>
      ...
      <section style={{ background: "#0D0807", padding: "5rem 2.5rem", textAlign: "center" }}>
        <div style={{ maxWidth: 540, margin: "0 auto" }}>
          ...
          <a href="https://amazon.com" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", padding: ".9rem 2.5rem", background: "#7A3A28", color: "#fff", borderRadius: 4, fontSize: ".82rem", fontWeight: 700, letterSpacing: ".08em", textTransform: "uppercase", textDecoration: "none" }}>Buy on Amazon →</a>
        </div>
      </section>
    </>
  );
