...
- [ ] Record CI results and tested [PREVIEW_ENVIRONMENT] evidence for that head SHA.
...
local checks → PR → tested [PREVIEW_ENVIRONMENT] → independent review → merge by owner → Production smoke test
