...
### Build health
- [ ] Typecheck passes: `[TYPECHECK_COMMAND]`.
- [ ] Lint passes: `[LINT_COMMAND]`.
- [ ] Tests pass: `[TEST_COMMAND_OR_N/A]` (state the reason for N/A).
- [ ] Production build passes: `[BUILD_COMMAND]` — do not skip it because dev "looks fine".
