...
const topics = [
  {
    ...
    desc: "The keynote. Why retirement is the most important beginning of your life — and how to design it on purpose.",
  },
  {
    title: "The 5 Mindsets of an Unretired Life",
    desc: "Freedom, Evolution, Balance, Relevance, Joy — the belief shifts that separate those who drift from those who design.",
  },
  {
    title: "Designing Life After the Title",
    desc: "What happens to identity when the role disappears, and how to build a self that doesn't depend on a business card.",
  },
  {
    title: "From Loss to Contribution",
    desc: "A candid talk on acceptance, resilience, and turning pain into purpose — the story behind the Hikmat Road Safety Program.",
  },
];
...
const formats = [
  {
    title: "Keynote",
    desc: "45–60 minutes for conferences, corporate events, and retirement-readiness programs.",
  },
  {
    title: "Workshop",
    desc: "Half- or full-day interactive sessions built around the framework and the Wheel of Life.",
  },
  {
    title: "Fireside / Panel",
    desc: "Moderated conversation or panel appearance on longevity, purpose, and the new retirement.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-7 order-2 lg:order-1 text-center lg:text-left">
              ...
              <p className="lede max-w-[52ch] mx-auto lg:mx-0 mb-9">
                Maher Kaddoura speaks to organizations, conferences, and
                communities about the most under-prepared transition of modern
                life — and how to meet it with intention, contribution, and joy.
                Honest, warm, and practical, with no clichés about slowing down.
              </p>
      ...
      <section className="bg-[#232F3F]">
        <div className="max-w-2xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl text-white leading-tight mb-3">
            Have a stage that needs this message?
          </h2>
          <p className="text-white/70 text-[16px] italic leading-[1.6] mb-9">
            Tell us about your event and we&apos;ll be in touch with
