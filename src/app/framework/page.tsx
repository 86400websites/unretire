...
const practices = [
  { title: "Ignite", desc: "Reignite your curiosity, creativity, and sense of aliveness.", href: "/framework/practice-ignite" },
  { title: "Move", desc: "Build a body that supports the life you want to live.", href: "/framework/practice-move" },
  { title: "Connect", desc: "Deepen the relationships that truly matter.", href: "/framework/practice-connect" },
  { title: "Contribute", desc: "Find your way of giving back with lasting impact.", href: "/framework/practice-contribute" },
  { title: "Explore", desc: "Embrace discovery — inward and outward.", href: "/framework/practice-explore" },
  { title: "Grow", desc: "Keep learning, stretching, and becoming.", href: "/framework/practice-grow" },
  { title: "Optimise", desc: "Design your days, energy, and environment intentionally.", href: "/framework/practice-optimize" },
];
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="max-w-3xl">
            ...
            <p className="lede max-w-[60ch]">
              Living fully is like building a bridge: your mindset is the foundation, and your daily
              practices are the bricks that hold it up. Without both, the structure doesn&apos;t stand.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <p className="prose-body leading-[1.85] mb-4">
                When Maher stepped away from his corporate roles, he realised something important:
                retirement doesn&apos;t magically become meaningful. You have to create meaning through
                both mindset and action.
              </p>
              <p className="prose-body leading-[1.85]">
                Over decades of experience, he developed a simple but life-changing formula:{" "}
            ...
            <div className="card relative overflow-hidden p-10 sm:p-12 text-center before:content-[''] before:absolute before:inset-x-0 before:top-0 before:h-[3px] before:bg-[#D05D11]">
              ...
              <p className="text-5xl sm:text-6xl font-bold text-[#232F3F] leading-none">Mindset</p>
              <p className="text-3xl text-[#D05D11] font-bold my-3">&times;</p>
              <p className="text-5xl sm:text-6xl font-bold text-[#232F3F] leading-none">Practice</p>
              <p className="prose-body text-[15px] leading-[1.8] mt-7 max-w-sm mx-auto">
                Neither works alone. The multiplication means each amplifies the other — raising the
                quality of your entire life design.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem]">The Five (Un)Retire Mindsets</h2>
            <span className="rule mt-6 mb-6 mx-auto" aria-hidden="true" />
            <p className="lede">
              These aren&apos;t motivational slogans. They are transformational belief shifts that
              unlock your ability to live fully in this new chapter.
            </p>
          </div>
            ...
            {mindsets.map((m) => (
              ...
              >
                ...
                <div className="md:col-span-4">
                  ...
                  <p className="text-[15px] italic text-[#D05D11] leading-snug">&ldquo;{m.quote}&rdquo;</p>
                </div>
                <p className="md:col-span-6 prose-body text-[15px] leading-[1.8]">{m.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#232F3F]">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14">
            ...
            <span className="block w-12 h-[3px] bg-[#D05D11] rounded-full mx-auto mt-6" aria-hidden="true" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {practices.map((p) => (
              ...
              >
                ...
                <p className="text-[13px] text-white/55 leading-[1.7] mb-4">{p.desc}</p>
