...
export default async function AccountPage({
  ...
  if (!userId) redirect("/unretire/login");
          ...
          {hasCourse ? (
            ...
            <>
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/unretire/premium" className="btn btn-crimson">Explore Premium</Link>
                <Link href="/unretire/learn/course" className="btn btn-outline">Buy the course</Link>
              </div>
            </>
          )}
        </div>
