...
const tools = [
  { img: "practice/starter-plan", title: "The 14-Day Starter Plan", desc: "Two weeks, one small move a day. The simplest way to feel the framework working before you finish the book.", cta: "Get it free →", href: "/unretire/start" },
  { img: "practice/toolkit", title: "The Practice Toolkit", desc: "A menu of experiments and small actions across the seven practices. Once a week, pick one and try it.", cta: "Explore the practices →", href: "/unretire/practice#practices" },
  { img: "practice/wheel-of-life", title: "The Wheel of Life", desc: "A quick, honest check across the eight dimensions of a full life. See where you've started muting yourself.", cta: "Take the 2-minute check →", href: "/unretire/assess" },
  { img: "diagrams/ikigai", title: "The Life Design Workbook", desc: "Structured reflection — purpose, passion, contribution — to personalise the framework to your own life.", cta: "From the book →", href: "/unretire/book" },
];
      ...
      <section className="bg-[#FBF5F2] border-y border-[#ECECEC]">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {tools.map((t) => (
              <Link key={t.title} href={t.href} className="card card-hover overflow-hidden flex flex-col sm:flex-row">
