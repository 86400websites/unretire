...
const tools = [
  { img: "starter-plan", title: "The 14-Day Starter Plan", desc: "Two weeks, one small move a day. Feel the framework work before you finish the book.", cta: "Download free →", href: "/start" },
  { img: "toolkit", title: "The Practice Toolkit", desc: "A menu of small experiments. Once a week, pick one and try it. No pressure, just motion.", cta: "Explore →", href: "/tools" },
  { img: "wheel-of-life", title: "The 2-Minute Check", desc: "A quick, honest read across every part of a full life. See which parts have gone quiet.", cta: "Take the check →", href: "/assess" },
];
