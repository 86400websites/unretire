...
const reach = [
  ...
  { title: "Speaking & events", desc: "Invite Maher to speak.", href: "/speaking", cta: "Speaking →" },
  { title: "Share your story", desc: "Tell us how you rebooted instead of muting.", href: "/stories", cta: "Stories →" },
