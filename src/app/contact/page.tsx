...
export const metadata = {
  title: "Contact",
  description:
    "Questions about the book, a speaking inquiry, or a story to share — get in touch with the (Un)Retire team.",
};

const reach = [
  {
    title: "General questions",
    desc: "About the book, the framework, or finding your way in.",
  },
  {
    title: "Speaking & events",
    desc: "Invite Maher to speak.",
    href: "/speaking",
    cta: "Speaking →",
  },
  {
    title: "Share your story",
    desc: "Tell us how you rebooted instead of muting.",
    href: "/stories",
    cta: "Stories →",
  },
      ...
      <section className="bg-white">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 text-center">
          ...
          <p className="lede max-w-[58ch] mx-auto">
            A question about the book, a speaking inquiry, or a story to share —
            we read everything. Drop a note and we&apos;ll get back to you.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            <div className="lg:col-span-5">
              ...
              <h2 className="text-2xl sm:text-3xl leading-tight mb-7">
                However we can help.
              </h2>
              <ul className="space-y-5">
                {reach.map((r) => (
                  <li key={r.title} className="flex items-start gap-3">
                    ...
                    <span>
                      <span className="block text-[16px] font-bold text-[#232F3F] leading-snug">
                        {r.title}
                      </span>
                      <span className="block prose-body text-[14px] text-[#666666] leading-[1.6]">
                        ...
                        {r.href && (
                          <>
                            ...
                            <Link
                              href={r.href}
                              className="text-[#D05D11] font-bold whitespace-nowrap"
                            >
                              {r.cta}
                            </Link>
                          </>
            ...
            {faqs.map((f) => (
              <details key={f.q} className="card group p-0 overflow-hidden">
                <summary className="flex items-center justify-between gap-4 cursor-pointer list-none p-6 text-[1.1rem] font-bold text-[#232F3F]">
                  {f.q}
                  <span
                    className="text-[#D05D11] flex-shrink-0 transition-transform duration-200 group-open:rotate-45"
                    aria-hidden="true"
                  >
                    <svg
                      width="20"
                ...
                <p className="prose-body text-[15px] text-[#444444] leading-[1.8] px-6 pb-6 -mt-1">
                  {f.a}
                </p>
              </details>
            ))}
