        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          ...
          <div className="rounded-2xl bg-[#FBF5F2] border border-[#ECECEC] p-7 sm:p-8 text-center">
            <p className="prose-body text-[16px] leading-[1.8] max-w-[60ch] mx-auto">
             ...
             <Link href="/start" className="text-[#D05D11] font-bold underline decoration-1 underline-offset-2 hover:text-[#8B1A1A] transition-colors">14-Day (Un)Retire Starter Plan</Link>, the{" "}
        <Link href="/tools" className="text-[#D05D11] font-bold underline decoration-1 underline-offset-2 hover:text-[#8B1A1A] transition-colors">Practice Toolkit</Link>, and the{" "}
        <Link href="/assess" className="text-[#D05D11] font-bold underline decoration-1 underline-offset-2 hover:text-[#8B1A1A] transition-colors">Wheel of Life — (Un)Retirement Edition</Link>.
</p>
          </div>
        </div>
      </section>
