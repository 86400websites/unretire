...
export const metadata = {
  title: "The Book",
  description:
    "(Un)Retire by Maher Kaddoura — the framework of 5 mindsets and 7 practices to design a next chapter with meaning, balance, and adventure.",
};
...
const BOOK_EDITIONS = [
  {
    format: "Paperback",
    size: "A5",
    href: "https://www.amazon.com/dp/B0H5D4N39D",
  },
  {
    format: "Hardcover",
    size: "A5",
    href: "https://www.amazon.com/dp/B0HCBTKVVB",
  },
  {
    format: "Paperback",
    size: "B5",
    href: "https://www.amazon.com/dp/B0H5CS433Q",
  },
  {
    format: "Hardcover",
    size: "B5",
    href: "https://www.amazon.com/dp/B0HCBYVDHH",
  },
  {
    format: "Kindle",
    size: "eBook",
    href: "https://www.amazon.com/dp/B0HDYSZ8T7",
  },
  {
    format: "Workbook",
    size: "A4 Paperback",
...
const mindsets = [
  { icon: "freedom", title: "Freedom", line: "Living life on your own terms" },
  {
    icon: "evolution",
    title: "Evolution",
    line: "Honor the past, but move forward",
  },
  { icon: "balance", title: "Balance", line: "A whole and fulfilled life" },
  {
    icon: "relevance",
    title: "Relevance",
    line: "You don't have an expiry date",
  },
...
const practices = [
  ...
  { icon: "connect", title: "Connect", line: "Build a circle that lifts you" },
  {
    icon: "contribute",
    title: "Contribute",
    line: "Offer wisdom without the lecture",
  },
  {
    icon: "explore",
    title: "Explore",
    line: "Use the power of novelty and play",
  },
  { icon: "grow", title: "Grow", line: "Deepen wisdom and inner alignment" },
  {
    icon: "optimize",
    title: "Optimize",
    line: "Manage your resources, by your design",
  },
];
...
export default function BookPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-7 order-2 lg:order-1 text-center lg:text-left">
              ...
              <p className="lede max-w-[52ch] mx-auto lg:mx-0 mb-9">
                Most retirement books prepare your finances and forget your
                life. (Un)Retire does the opposite. It hands you a framework —
                five mindsets and seven practices — to design a next chapter
                with meaning, balance, and adventure. Not advice on how to take
                it easy. A blueprint for living fully, at any age.
              </p>
            ...
            <div className="lg:col-span-5 order-1 lg:order-2">
              <div className="relative mx-auto w-full max-w-[280px] sm:max-w-[320px]">
                <div
                  className="absolute -inset-8 bg-[radial-gradient(ellipse,rgba(208,93,17,0.12),transparent_70%)]"
                  aria-hidden="true"
                />
                <Image
      ...
      <section className="bg-[#FBF5F2] border-y border-[#ECECEC]">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 text-center">
          ...
          <p className="text-[1.35rem] sm:text-[1.5rem] leading-[1.55] text-[#232F3F] mb-6">
            They tell you retirement is freedom. They tell you it&apos;s rest.
            They tell you you&apos;ve earned it.
          </p>
          <p className="prose-body text-[17px] leading-[1.85] mb-6">
            What they don&apos;t tell you is this: retirement, done wrong,
            doesn&apos;t feel like freedom. It feels like drift. This book is
            the invitation to flip the script — to see retirement not as a
            finish line, but as a threshold. A moment when experience finally
            meets freedom.
          </p>
          <p className="text-[1.35rem] sm:text-[1.5rem] italic leading-[1.5] text-[#D05D11]">
            Because the most dangerous thing about retirement isn&apos;t
            stopping work. It&apos;s stopping yourself.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14">
            ...
            <p className="lede">
              ...
              . How you think, multiplied by what you do.
            </p>
          </div>
          ...
          <div className="mb-12 sm:mb-14">
            <div className="flex items-center gap-4 mb-7">
              ...
              <span className="text-[12px] font-bold tracking-[0.12em] uppercase text-[#666666]">
                How you think
              </span>
          ...
          <div className="rounded-2xl bg-[#FBF5F2] border border-[#ECECEC] p-7 sm:p-8 text-center">
            <p className="prose-body text-[16px] leading-[1.8] max-w-[60ch] mx-auto">
              ...
              <Link
                href="/start"
                className="text-[#D05D11] font-bold underline decoration-1 underline-offset-2 hover:text-[#8B1A1A] transition-colors"
              >
                14-Day (Un)Retire Starter Plan
              </Link>
              , the{" "}
              <Link
                href="/tools"
              ...
              <Link
                ...
                className="text-[#D05D11] font-bold underline decoration-1 underline-offset-2 hover:text-[#8B1A1A] transition-colors"
              >
                Wheel of Life — (Un)Retirement Edition
              </Link>
              .
            </p>
          </div>
      ...
      <section
        id="editions"
        className="bg-[#FAF5F0] border-y border-[#ECE5DB] scroll-mt-24"
      >
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {BOOK_EDITIONS.map((ed) => (
              ...
              >
                <span>
                  <span className="block text-[17px] font-bold text-[#232F3F]">
                    {ed.format}
                  </span>
                  <span className="block text-[13px] text-[#837A6E] mt-0.5">
                    {ed.size}
                  </span>
                </span>
