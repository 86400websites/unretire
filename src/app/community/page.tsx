...
const offerings = [
  {
    ...
    desc: "Guided group conversations on framework themes — purpose, identity, relationships, time, and legacy. Real talk, no performance.",
  },
  {
    title: "Reading & Reflection Circles",
    desc: "Small groups working through the book or workbook together — sharing reactions, insights, and honest reflections.",
  },
  {
    title: "Live Events & Workshops",
    desc: "Monthly live sessions with Maher and guest contributors. Practical, focused, and built around your real questions.",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="max-w-3xl">
            ...
            <p className="lede max-w-[60ch]">
              A growing circle of people designing their retirement with
              intention — sharing, supporting, and learning together.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            <div>
              ...
              <p className="prose-body leading-[1.85] mb-4">
                The (Un)Retire framework includes Connect as one of its seven
                core practices — because the research is unambiguous: strong
                relationships are the single greatest predictor of a long,
                healthy, and meaningful life.
              </p>
              <p className="prose-body leading-[1.85] mb-9">
                The Community is where that practice comes to life. A space for
                people thinking intentionally about their next chapter — not to
                be told what to do, but to think, share, and grow alongside
                others in the same season of life.
              </p>
            ...
            <div className="card p-8 sm:p-10">
              <blockquote className="text-[1.3rem] sm:text-[1.45rem] italic text-[#D05D11] leading-[1.55] mb-5">
                &ldquo;The most powerful conversations I&apos;ve had about
                retirement haven&apos;t been with financial advisers.
                They&apos;ve been with people living it.&rdquo;
              </blockquote>
        ...
        <div className="max-w-xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center mb-9">
            ...
            <p className="text-white/80 text-[15px] leading-[1.7] max-w-md mx-auto">
              Tell us a little about where you are in your (Un)Retire journey
