...
import CheckoutButton from "@/app/premium/CheckoutButton";
      ...
      <section className="bg-white">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 pt-16 pb-12 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl leading-[1.08]">
            Design the next chapter. Ten modules.
          </h1>
          <span className="rule mt-7 mb-7 mx-auto" aria-hidden="true" />
          <p className="lede max-w-[58ch] mx-auto mb-4">
            The book&apos;s companion course, at your own pace. Ten modules,
            forty-eight lessons, a short video and a workbook you&apos;ll
            actually use with every one.
          </p>
          <p className="prose-body font-bold text-[#1B1B1B] text-[17px] mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {[
              ...
              <div key={s.l} className="card p-6 text-center">
                <p className="text-[2rem] leading-none text-[#D05D11] mb-2">
                  {s.n}
                </p>
        ...
        <div className="max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl">
              Start where you are. Finish with a plan.
            </h2>
            ...
            {modules.map((m) => (
              ...
              >
                ...
                <span className="flex-1 min-w-0">
                  <span className="block text-[1.1rem] text-[#232F3F] leading-snug mb-1">
                    {m.title}
                  </span>
        ...
        <div className="max-w-2xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          {unlocked ? (
            ...
            <>
              ...
              <p className="text-5xl sm:text-6xl font-bold text-white leading-none mt-6 mb-2">
                $99
              </p>
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <Link
                  href="/premium"
                  className="text-white text-[14px] underline hover:opacity-80"
                >
