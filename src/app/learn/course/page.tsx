        ...
        <div className="max-w-2xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          {unlocked ? (
            <>
              ...
              <Link href="/learn/course/module-1" className="btn bg-white text-[#232F3F] hover:bg-[#F5F5F5]">
                Start the course →
              </Link>
            </>
          ) : (
            <>
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                />
                <Link href="/premium" className="text-white text-[14px] underline hover:opacity-80">
