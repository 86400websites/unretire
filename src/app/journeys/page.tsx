...
const journeys = [
  { title: "The Purpose Journey", desc: "Rediscover your reason to rise", stages: "6 stages · ~8 weeks", access: "free", href: "/journeys/purpose" },
  { title: "The Vitality Journey", desc: "Build a body that matches your ambitions", stages: "5 stages · ~6 weeks", access: "premium", href: "/journeys/health" },
  { title: "The Connection Journey", desc: "Deepen the relationships that truly matter", stages: "5 stages · ~8 weeks", access: "premium", href: "/journeys/relationships" },
  { title: "The Contribution Journey", desc: "Find your way of giving back with impact", stages: "5 stages · ~6 weeks", access: "premium", href: "/journeys/contribution" },
  { title: "The Adventure Journey", desc: "Embrace exploration in your next chapter", stages: "5 stages · ~6 weeks", access: "premium", href: "/journeys/adventure" },
  { title: "The Life Design Journey", desc: "Architect the days you actually want to live", stages: "6 stages · ~10 weeks", access: "premium", href: "/journeys/design" },
  { title: "The Mindset Journey", desc: "Rewire the beliefs that hold you back", stages: "5 stages · ~8 weeks", access: "premium", href: "/journeys/mindset" },
];
    ...
    <>
      ...
      <section className="bg-[#D05D11]">
        <div className="max-w-2xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          ...
          <Link href="/community" className="btn bg-white text-[#D05D11] hover:bg-[#232F3F] hover:text-white">
            Join Premium →
          </Link>
        </div>
      </section>
