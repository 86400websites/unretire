...
export const metadata = {
  ...
  description:
    "Get the free 14-Day (Un)Retire Starter Plan by email, take the 2-minute Wheel of Life check, or open the book — one small step is all it takes.",
};
      ...
      <section className="bg-white">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 text-center">
          ...
          <p className="lede max-w-[58ch] mx-auto mb-9">
            Fourteen days. One small move a day. The free 14-Day Starter Plan is
            the simplest way to feel the (Un)Retire framework working — before
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {steps.map((s) => {
              ...
              const inner = (
                <>
                  {s.highlight && (
                    <span className="absolute top-4 right-4 text-[10px] font-bold tracking-[0.1em] uppercase bg-[#D05D11] text-white rounded-full px-2 py-0.5">
                      Free
                    </span>
                  )}
      ...
      <section className="bg-white">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-left mb-9">
            {[
              {
                week: "Week 1 — Reawaken",
                desc: "Notice what&apos;s still alive in you. Ignite, Move, Connect, Explore, Grow — seven small actions that wake things up.",
              },
              {
                week: "Week 2 — Build",
                desc: "Turn noticing into motion. Balance, Contribute, Joy, Optimize — seven actions that build real momentum.",
              },
            ].map((w) => (
              <div key={w.week} className="card p-6">
                <p className="text-[11px] font-bold tracking-[0.1em] uppercase text-[#D05D11] mb-2">
                  {w.week}
                </p>
                <p
                  className="prose-body text-[15px] text-[#444444] leading-[1.75]"
