...
const profiles = [
  {
    href: "/unretire/profile/status-dropper",
    title: "The Status Dropper",
    quote: '"I didn\'t realise how much my title defined me."',
  },
  {
    href: "/unretire/profile/comfortable-drifter",
    title: "The Comfortable Drifter",
    quote: '"Life is pleasant... but it feels a little flat."',
  },
  {
    href: "/unretire/profile/family-first-caretaker",
    title: "The Family-First Caretaker",
    quote: '"My time now revolves around family."',
  },
  {
    href: "/unretire/profile/still-ambitious-builder",
    title: "The Still-Ambitious Builder",
    quote: '"I\'m not finished creating."',
  },
  {
    href: "/unretire/profile/health-reset-retiree",
    title: "The Health Reset Retiree",
    quote: '"Now it\'s time to take care of myself."',
  },
  {
    href: "/unretire/profile/forced-retiree",
    title: "The Forced Retiree",
    quote: '"I didn\'t choose this transition."',
  },
];
    ...
    <>
      ...
      <section
        style={{
          ...
          alignItems: "center",
          background:
            "linear-gradient(160deg,#2C1A0E 0%,#1A1008 40%,#0F0A05 100%)",
          padding: "calc(64px + 3rem) 2.5rem 4rem",
          position: "relative",
          overflow: "hidden",
        }}
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 60% 50%,rgba(180,90,20,.12) 0%,transparent 65%)",
            pointerEvents: "none",
          }}
        />
        <div
        ...
        >
          ...
          >
            ...
            >
              <div
                style={{
                  ...
                  justifyContent: "center",
                  marginBottom: "1.2rem",
                  boxShadow: "0 8px 24px rgba(122,58,40,.4)",
                  flexShrink: 0,
                }}
              >
            ...
            >
              ...
              >
                Reboot. Don&apos;t Mute. The beginning of an intentional next
                chapter.
              </p>
            </div>
          </div>
          <div>
            ...
            >
              ...
              financially — but avoid emotionally. (Un)Retire gives you the
              framework to design what comes next — on purpose, not by default.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "#111108", padding: "6rem 2.5rem" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            ...
            >
              For generations, retirement has been framed as the reward for a
              lifetime of work — a time to slow down, step aside, and finally
              rest.
            </p>
          </div>
          <div
              ...
              >
                <div
                  style={{
                    ...
                    border: "1px solid rgba(122,58,40,.25)",
                    borderRadius: 10,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
          ...
          >
            ...
            >
              &ldquo;The real risk is not aging. It&apos;s muting yourself —
              your curiosity, your contribution, your sense of relevance, your
              joy.&rdquo;
            </p>
            <p
              style={{
            ...
            >
              &ldquo;Retirement is not a finish line. It&apos;s an inflection
              point — a new beginning.&rdquo;
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "#0D0807", padding: "6rem 2.5rem" }}>
        ...
        >
          <div>
            ...
            >
              (Un)Retire is not about working forever. It&apos;s not about
              staying busy. It&apos;s not about denying age or pretending
              nothing has changed.
            </p>
            <p
              style={{
            ...
            >
              ...
              your identity when old labels fall away.{" "}
              <strong style={{ color: "#F2EDE4", fontWeight: 500 }}>
                Choosing
              </strong>{" "}
              purpose over drift.{" "}
              ...
              a life that feels whole — not just comfortable.
            </p>
            <p
              style={{
                fontFamily: "var(--serif)",
          ...
          >
            ...
            >
              Five powerful mindsets. Seven intentional practices. Together, a
              complete guide for the next chapter of life.
            </p>
            <Link
              href="/unretire/framework"
              style={{
      ...
      <section style={{ background: "#F2EDE4", padding: "6rem 2.5rem" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            The building blocks of an intentional life after career.
          </p>
          <div
            style={{
              display: "flex",
      ...
      >
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            ...
            <p style={{ fontSize: ".88rem", color: "#9A9080" }}>
              The (Un)Retire journey speaks to people at many different points
      ...
      <section style={{ background: "#0D0807", padding: "7rem 2.5rem" }}>
        ...
        >
          ...
          <div>
            ...
            >
              From &ldquo;Reboot Don&apos;t Mute&rdquo; to the 14-Day Starter
              Plan — a comprehensive framework for approaching retirement not as
              an end, but as a beginning.
            </p>
            <div
              style={{
                display: "flex",
      ...
      >
        <div style={{ maxWidth: 540, margin: "0 auto" }}>
          ...
          >
            Weekly insights on designing the life you were made for — delivered
            every Monday morning.
          </p>
          {submitted ? (
            <p style={{ color: "rgba(255,255,255,.9)", fontSize: ".9rem" }}>
