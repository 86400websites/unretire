...
- [ ] 🔴 **I7 — Public writes validated and abuse-controlled.** `/api/subscribe` et al. validate server-side and carry the §5 abuse controls, failing **CLOSED** in Production. *(set 2026-08-26 — validation present; abuse controls **NOT MET** — Known issue 5, Sprint S4.5, stack decision D-9)*
