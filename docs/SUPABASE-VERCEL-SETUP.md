...
> satisfied in halves until S2.1 records both.~~ **Updated 2026-08-27 (Sprint S2.1, in progress — PR not yet opened):**
> `.github/workflows/code-check.yml` now **exists on the S2.1 branch** `claude/s2.1-code-check-ci`
> (verbatim from `docs/TECHNICAL-INTEGRITY.md`; PR not yet opened). The workflow is installed by S2.1 and
